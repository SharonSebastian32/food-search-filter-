...
fetch("https://dummyjson.com/recipes")
  ...
  .then((data) => {
    const recipeContainer = document.getElementById("recipe-root"); // Select the container where the cards will be displayed
    ...
    data.recipes.forEach(function (recipe) {
      recipeContent += `
        <div class="card">
          ...
          <p style="color: red; font-size:20px"><strong>Instructions:</strong> ${
            recipe.instructions
          }</p>
        </div>
      `;
